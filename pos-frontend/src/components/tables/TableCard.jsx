    ...
    return (
        ...
        <div onClick={()=>handleClick(name)} key={key} className='w-[300px] hover:bg-[#1f1f1f] bg-[#262626] rounded-lg p-4 mb-4 cursor-pointer'>
            ...
            <div className='flex items-center justify-center my-5'>
                 <h1 style={{ backgroundColor: initials ? randomColor :"#1f1f1f" }} className="text-white rounded-full w-16 h-16 flex items-center justify-center text-xl">{getAvatarName(initials)||"N/A"}</h1>
            </div>
