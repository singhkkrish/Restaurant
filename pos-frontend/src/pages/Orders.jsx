...
const Orders = () => {
  ...
  return (
    <section className='bg-[#1F1F1F] h-screen flex flex-col relative '>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-16 py-2 overflow-y-auto scrollbar-hide flex-grow  pb-20">
        {
